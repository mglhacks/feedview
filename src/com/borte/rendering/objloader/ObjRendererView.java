package com.borte.rendering.objloader;
...
public class ObjRendererView extends GLSurfaceView implements Renderer {
	...
	public ObjRendererView(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		init(context);
	}

	public ObjRendererView(Context ctx) {
		super(ctx);
		init(ctx);
	}
	...
	public void init(Context context) {
		...
		model=parser.parseOBJ("mesh.obj");
	...
	public void onDrawFrame(GL10 gl) {
		...
		//		gl.glFrustum((-x + ShiftX)/k, (x + ShiftX)/k, (-y + ShiftY)/k, (y + ShiftY)/k, zNear, zFar);
		//		gl.glLoadIdentity();
		//		gl.gluLookAt(x - ShiftX, y - ShiftY, Distance, x - ShiftX, y - ShiftY, 0.0, 0.0, 1.0, 0.0);
